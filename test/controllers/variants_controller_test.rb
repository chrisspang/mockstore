...
class VariantsControllerTest < ActionController::TestCase
  ...
  test "should create variant" do
    assert_difference('Variant.count') do
      post :create, variant: { is_master: @variant.is_master, position: @variant.position, price: @variant.price, product_id: @variant.product_id, sku: @variant.sku }
    end
  ...
  test "should update variant" do
    patch :update, id: @variant, variant: { is_master: @variant.is_master, position: @variant.position, price: @variant.price, product_id: @variant.product_id, sku: @variant.sku }
    assert_redirected_to variant_path(assigns(:variant))
  end
